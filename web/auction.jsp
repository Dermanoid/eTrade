...
<html>
    ...
    <body class="auctionBody">
      ...
      <a href="Trade.jsp" class="InboxBtnForm" type="button" id="InboxBtn">Inbox</a>
...
<%
    ...
    for (Item item : itemlist) {
        ...
        out.write("<a href=\"PersonalAcc.jsp?offer=true&sendItemId=" + item.getId() + "\"> Offer </a>" + "<a href=\"DetailedInfo.jsp\">     More... </a>");
        out.write("</div>");
    }
%>
</body>
